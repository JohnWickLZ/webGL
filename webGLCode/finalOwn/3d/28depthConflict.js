...
window.onload = function init() {
    ...
    var dataVertices = new Float32Array([
        0.75, 1.0,  0.0,   1.0, 1.0, 1.0,  //钱
        0.25, -1.0, 0.0,   1.0, 1.0, 1.0,
        1.25, -1.0, 0.0,   1.0, 1.0, 1.0,

        0.75,  1.2, 0.0,  0.4, 1.0, 0.4, //后
        0.15, -1.2, 0.0,  0.4, 1.0, 0.4,
        1.35, -1.3, 0.0,  0.4, 1.0, 0.4
    ]);
    ...
    function run(){
        ...
        viewMatrix.setLookAt(0, 1, 5, 0, 0, -100, 0, 1, 0);
